    ...
    class StarshipViewController: UIViewController {
        ...
        override func viewDidLoad() {
            ...
            getPeople(from: API.fetchEndpoint(endpoint: .starships))
            setupTV()
    ...
    typealias StarDataSource = StarshipViewController
    extension StarDataSource : UITableViewDataSource{
    ...
    typealias StarDelegate = StarshipViewController
    extension StarDelegate :UITableViewDelegate{
