...
class PlanetViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        getPeople(from: API.fetchEndpoint(endpoint: .planet))
        setupTV()
...
typealias PDataSource = PlanetViewController
extension PDataSource : UITableViewDataSource{
...
typealias PDelegate = PlanetViewController
